...
\title{Intro to Banach-valued Analysis: exam questions}
...
%% Main matter
The oral exam will have the following format: first, you present an answer to a question of your choice, and then we will ask you to present an answer to a random question.
If you can't answer the question we give you, we will ask you another random question.
After you successfully answer a question from us, you can present an answer to another question of your choice, and the process repeats until 30 minutes have passed.
You are allowed to consult the lecture notes during the exam.

As the exams will take place on Zoom, you are basically required to give a verbal sketch of the proof, with additional notes on paper if necessary.
Make sure to test your microphone and camera before the exam!
