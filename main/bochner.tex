...
\begin{prop}\label{prop:positive-extensions}
  Fix a measure space $(S,\mc{A},\mu)$ and $p,q \in [1,\infty)$.
...
Proposition \ref{prop:positive-extensions} shows that the `extension problem' for positive operators is not much of a problem: positive operators extend automatically.
