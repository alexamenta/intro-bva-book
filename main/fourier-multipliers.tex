...
\end{defn}
\todo{make sure all spaces are complex here}
...
\begin{proof}
  ...
  Then for $\xi \in I$ we have the identity\todo{insert lemma: $R$-boundedness of the one-sided limits}
  \begin{equation*}
    \begin{aligned}
      \1_{I}(\xi)M(\xi)
