...
\begin{thm}[Burkholder--Bourgain, 1983]\index{theorem!Burkholder--Bourgain}
  The $X$-valued Hilbert transform is bounded on $L^p(\R;X)$ for some (equivalently, all) $p \in (1,\infty)$ if and only if $X$ has the \emph{UMD property}.\index{UMD space}
\end{thm}
