...
For the following estimates we use the Rademacher spaces $\varepsilon(X)$ defined in Section \ref{sec:rademacher-spaces}.\todo{note: square function charactersiation of $Lp$ norm of martingales}
