...
We will prove this as a result of \emph{Gundy's decomposition} for martingales, which is analogous to the Calder\'on--Zygmund decomposition of a function.
First we'll state Gundy's decomposition and use it to prove Theorem \ref{thm:UMD-p-independent}.
Then, after discussing consequences of Theorem \ref{thm:UMD-p-independent}, we will return to the proof of Gundy's decomposition.
