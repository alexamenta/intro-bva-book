...
Thanks to Timothy Banova, Marco Fraccaroli, Sebastian Gietl, Yesheng Huang, Victor Olmos, Lennart Ronge, Aidan Schumann, and Feng Shao for comments and corrections.\footnote{These notes are still in progress, so if you want to be in this list, just point out some mistakes!}
...
\textbf{Changes since v0.8}
\begin{itemize}
\item The chapter on necessity of the UMD condition has been added.
